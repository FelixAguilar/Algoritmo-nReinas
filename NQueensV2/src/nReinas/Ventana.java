...
//    private final int EY = 4;
    ...
    private void initContents() {
        ...
        JMenuItem tamaño = new JMenuItem("NReinas (todas las sol)");
        tamaño.addActionListener((event) -> accionTamaño());
        JMenuItem reina = new JMenuItem("NReinas (reina fija)");
    ...
    private void accionTamaño() {
        ...
        try {
            ...
            if(indice == 0){
                JOptionPane.showMessageDialog(null, "No se ha encontrado ninguna"
                        + " solucion.", "Algoritmo nReinas", 
